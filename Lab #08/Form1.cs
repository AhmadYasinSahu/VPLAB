...
namespace Activity_01_Lab
{
    public partial class Form1 : Form
    {
        ...
        private void loadCustomer()
        {
            try
            {
                string strconnection = "Data Source=AUMC-LAB3-05\\SQLEXPRESS;Initial Catalog=CustomerDB;Integrated Security=True";
                ...
                try
                {
                    ...
                    using (SqlConnection objconnection = new SqlConnection(strconnection))
                    {
                        ...
                        using (SqlCommand objCommand = new SqlCommand(strcommand, objconnection))
                        {
                            ...
                            {
                                MessageBox.Show("Customer Data Unable to save ", "Error", MessageBoxButtons.OK);
                            }
                        }
                        loadCustomer();
                        clearForm();
